...
1. **Pre-build vs post-build**: new features, planning → `/pre-mortem`; implementation done → `/post-mortem`
2. **Meta skills**: pre-mortem, post-mortem, diagnose, zoom-out, improve-architecture, caveman — invoked directly by name
3. **Zoom-out vs improve-architecture**: explain how the code fits → `/zoom-out`; refactor a module to be deeper/more testable → `/improve-architecture`
